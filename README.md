...
| ✅ | ESG report entity extraction and report automation | Automation handler (Not in original scope) | bash exec to simplify full integration | [Github](https://github.com/example) | 05/05 |
