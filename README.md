...
The language model (live here http://18.219.52.58:3000/), one of the key deliverables of this work, accepts a user input text in the form of a question or unfinished thought and returns an answer or summary based on relevant material found in the ESG document. 
